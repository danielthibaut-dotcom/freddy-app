...
def build_parser():
    ...
    pb = sub.add_parser('batch'); pb.add_argument('input', nargs='?'); pb.add_argument('--out'); pb.add_argument('--track', default='auto'); pb.add_argument('--resume', action='store_true'); pb.add_argument('--zip-output', action='store_true'); pb.add_argument('--mirror-tree', action='store_true'); pb.add_argument('--max-projects', type=int, default=0)
    pa = sub.add_parser('auto'); pa.add_argument('--out'); pa.add_argument('--track', default='auto'); pa.add_argument('--resume', action='store_true'); pa.add_argument('--zip-output', action='store_true'); pa.add_argument('--mirror-tree', action='store_true'); pa.add_argument('--max-projects', type=int, default=0)
